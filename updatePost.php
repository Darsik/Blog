...
$param = array($_GET['id']);
$posts = Db::dotazVsechny('SELECT * FROM post WHERE id=?', $param);
...
if(isset($_POST['submit']))
{
	if($_POST['title'] != "" && $_POST['text'] != "" && $_POST['perex'] != "")
			{
				$model->upravitPost($_GET['id'], $_POST['title'], $_POST['text'], $_POST['perex']);
  ...
  <div class="info-bar">
    <?php
      if(isset($_SESSION['USER'])) { 
        ...
        echo "<a href='renderPost.php?id=" . $_GET['id'] . "' class='add'>Zpět</a>";
      } 
    ?>
  </div>
  <div class="upravitPost">
    <form method="post">
    	<div class="inline"><p class="elem">Titulek:</p><input type="text" name="title" class="title bord" value="<?php echo $title; ?>"></div>
	    <div class="inline"><p class="elem">Perex:</p><textarea name="perex" class="bord"><?php echo $perex; ?></textarea></div>
    	<div class="left"><p class="elem">Text:</p><textarea id="edit" name="text"><?php echo $text; ?></textarea></div>
